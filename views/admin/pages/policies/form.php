        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0" style="font-size: 0.8rem;">
                    ...
                    <li class="breadcrumb-item"><a href="<?= BASE_URL_ADMIN ?>&action=policies" class="text-muted text-decoration-none">Quản lý Chính sách</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?= $pageTitle ?></li>
                </ol>
            </nav>
            <h4 class="fw-bold mb-0 mt-1" style="font-size: 1.25rem; letter-spacing: -0.5px;"><?= $pageTitle ?></h4>
        </div>
        <div class="d-flex gap-2">
            <a href="<?= BASE_URL_ADMIN . '&action=policies' ?>" class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
                <i class="ph ph-x" style="font-size: 1.1rem;"></i> Hủy bỏ
            </a>
            <button type="submit" form="policy-form" class="btn btn-primary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
                <i class="ph ph-floppy-disk" style="font-size: 1.1rem;"></i> <?= $isEdit ? 'Cập nhật' : 'Tạo mới' ?>
            </button>
        </div>
    </div>
