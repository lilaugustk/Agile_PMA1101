...
<main class="content">
    <div class="d-flex justify-content-between align-items-end mb-4 pb-2">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0" style="font-size: 0.8rem;">
                    ...
                    <li class="breadcrumb-item"><a href="<?= BASE_URL_ADMIN ?>&action=suppliers" class="text-muted text-decoration-none">Nhà Cung Cấp</a></li>
        ...
        <div class="d-flex gap-2">
            <a href="<?= BASE_URL_ADMIN . '&action=suppliers' ?>" class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
                <i class="ph ph-x" style="font-size: 1.1rem;"></i> Hủy bỏ
            </a>
            <button type="submit" form="supplier-form" class="btn btn-primary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
