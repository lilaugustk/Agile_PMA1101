...
<main class="content">
    <div class="d-flex justify-content-between align-items-end mb-4 pb-2">
        <div>
            ...
            <h4 class="fw-bold mb-0 mt-1" style="font-size: 1.25rem; letter-spacing: -0.5px;">Chi Tiết Nhà Cung Cấp</h4>
        </div>
        <div class="d-flex gap-2">
            <a href="<?= BASE_URL_ADMIN . '&action=suppliers/edit&id=' . $supplier['id'] ?>" class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
                <i class="ph ph-pencil-simple" style="font-size: 1.1rem;"></i> Chỉnh sửa
            </a>
            <a href="<?= BASE_URL_ADMIN . '&action=suppliers' ?>" class="btn btn-primary d-flex align-items-center gap-2 px-3 py-2 shadow-sm" style="border-radius: var(--radius-md);">
